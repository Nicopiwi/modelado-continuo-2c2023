...
# ╔═╡ b6add9d4-0452-4a78-aae2-883cbc38b329
md"""Una particularidad de esta forma de manejar imágenes es que los tres canales (sean `R`, `G`, `B` ó `Y`, `Cb`, `Cr`) están integrados del tipo de dato en cada casillero de la matriz. Para separar las componentes puede usarse el comando `channelview`:"""

# ╔═╡ 2043532b-f3cb-4c9f-8f1c-e6386b8d375e
random_im = YCbCr.(rand(RGB,200,200)) # creo una imagen rando y la convierto a YCbCr

# ╔═╡ 2a3ac14b-749e-4c10-a666-e88032f72964
separados = channelview(random_im)

# ╔═╡ 54490127-c861-456c-a1fb-f5a5036b855e
size(separados)

# ╔═╡ 030881c4-b965-4a9a-987c-1a49d266ad08
begin
	y  = separados[1,:,:]
	cb = separados[2,:,:]
	cr = separados[3,:,:]
...
# ╔═╡ 62cb67c1-b182-4e31-998e-0254f03a1785
colorview(YCbCr,y,cb,cr)
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "dd05697c5115fcdb53bbc09af33d5c08cbaca3b2"
